        ...
        <div className="p-10">
            ...
            <div className="bg-bgGrey mt-8 p-8 rounded-lg md:flex md:items-start">
                <p className="font-poppins md:w-1/2">
                    ...
                    Currently, I am diving deeper into the MERN stack, honing my expertise to create innovative and
                ...
                <div className="mt-8 md:mt-0 md:ml-40">
                    ...
                    <div className="flex">
                        ...
                        <div className="pl-6">
                            <h5 className="font-poppins">Bachelor of Software Engineering</h5>
